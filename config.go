...
type config struct {
	...
	RPCClientTLSDisable bool   `long:"RPCClientTLSDisable" description:"Do not use TLS over RPC on btcd listening RPC server"`
...
func loadConfig() (*config, error) {
	defaultCfg := config{
		...
		RPCClientTLSDisable: defaultRPCClientTLSDisable,
